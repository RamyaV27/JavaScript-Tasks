...
// A reusable spacer object for formatting
var spacer = {
  blank: function () {
      return "";
  },
...
var player2 = new Player("Drogon", 80);
var armory = new Place(
  "The Royal Armory",
  "You are in an armory filled with weapons and armor."
);
player2.place = armory;
player2.addItem("a shiny helmet");
player2.addItem("Dragonfire spear");

// 2) Add items for each player
player2.addItem("Iron Shield");
player1.addItem("Magic Potion");

// 3) Display each player's info
player1.showInfo("=");
player2.showInfo("=");

// 4) Write a method to drop the last item in a player's items array
player1.dropLastItem();
player2.dropLastItem();

// Display updated player info after dropping the last item
